...
app.controller("HubController", 
  ...
  function upsertCampaign(address) {
    ...
    .then(function(_fundsRaised) {
      ...
      return campaign.refunded.call({from: $scope.account});
    })
    .then(function(_refunded) {
      campaignRefunded = _refunded;
      //console.log("Refunded", _refunded);
    ...
    .then(function(_hasFailed) {
      ...
      c.refunded  = parseInt(campaignRefunded.toString(10));
